...
very low entropy (we define entropy mathematically in
\refsec{stats-entropy}).  Low entropy arises when the uncertainty in
the category of an item given the classifier's decision is low.  The
