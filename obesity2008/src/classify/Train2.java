...
public class Train2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String modelFileName = "non-cvs/models/run2";
	...
	Corpora corpora = new Corpora(patientFiles,annotationFiles,false); // false = no normalization
    ...
    public static Compilable createClassifier(final XValidatingClassificationCorpus<CharSequence> corpus) 
        ...
        AnnealingSchedule annealingSchedule 
            = AnnealingSchedule.exponential(0.0002,0.9999);

        LogisticRegressionClassifier<CharSequence> classifier
            = LogisticRegressionClassifier.train(Train2.FEATURE_EXTRACTOR,
                                                 trainingCorpus,
                                                 minFeatureCount,
                                                 addIntercept,
                                                 prior,
    ...
    public static final FeatureExtractor<CharSequence> FEATURE_EXTRACTOR
        = new TokenFeatureExtractor(Train2.SIMPLE_TOKENIZER_FACTORY);
