...
directory, which is here the directory containing the \code{build.xml}
file, namely \relpath{src/intro}.
...
relative to the base directory, which is the one holding the
\code{build.xml} file.
...
specifying that the properties from teh file \code{demo.properties}
be read in.
%
