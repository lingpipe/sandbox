...
\subsection{The Serialization Proxy Pattern}
...
limitations of default serialization.  Our recommended approach to
serialization is to use the serialization proxy pattern.  
