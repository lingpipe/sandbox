\chapter{Troubleshooting Text}\label{chap:text-trouble}
...
In  \refsec{example-conversions}, the
demo class \code{ByteToString.java} contains 
methods \code{dumpString(String)} and \code{dumpBytes(byte[])}.
%
