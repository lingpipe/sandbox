...
In this book we take the time to answer these questions thoroughly
because understanding how character data is encoded into bytes and
how this data is sent to and retrieved from the operating system is
a prerequisite for building systems that do any kind of text data processing.
Natuaral language processing applications interpret characters and strings
as meaningful texts in a language.  ``hello world'' 
