...
\subsection{Adapting Analyzers to Tokenizer Factories}

A Lucene analyzer together with the name of a field implements roughly
the same functionality as a LingPipe \code{TokenizerFactory}.  
