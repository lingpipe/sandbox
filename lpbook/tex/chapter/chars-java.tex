...
\subsubsection{Iterating over Code Points in a CharSequence}\label{section:iterate-by-code-points}
...
%
It provides a static utility method \code{isValidUTF16(CharSequence)} 
