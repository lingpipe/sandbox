...
(\stringmention{...}), are handled as single tokens.
...
We provide an implementation of the Penn Treebank tokenizer based on
Robert MacIntyre's SED script in the class
\code{PennTreebankTokenizerFactory}.
