...
\subsubsection{Consequences of Encoding Schemes}
...
In particular, the legacy character sets Latin-1 et al
...
%
\commandlinefollow{cd \rootdir/src/java/chars}%
...
of which are available programatically.  We implement a \code{main()}
