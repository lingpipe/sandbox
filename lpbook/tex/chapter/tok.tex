...
\section{Some Silly UTF-8 and Arabic Tests}

Let's see if we can do Latin1 chars in UTF-8:

Déjà vu


Here's transliterated Arabic source in \code{RLtext}
...
Inline, using \code{RL}, we get \RL{السَلامُ عَليكم ورَحمةُ الله وبَركاته}, which
is inline.

With \code{arabtext}, we get a display.
