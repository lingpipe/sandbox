...
On my MacBook running Mac OS X the output is
\commandlinefollow{ant get-encoding}
\begin{verbatim}
encoding: US-ASCII
\end{verbatim}
...
To combat the first problem, we 
...
On cygwin, this is controled by the Options menu item.


via the menu item Options (Cygwin)/Properties(Mac OSX) controls.
