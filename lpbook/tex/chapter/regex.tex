...
provides an immutable representation of a regular expression.  

An instance of \code{Matcher} represents the
state of the matching of a regular expression against a string.  
...
The most basic regular expressions describe either characters
or character classes.  Some characters are reserved and need
to be escaped for use in regular expresions.  
...
attachment for character oprations is
%
\begin{center}
\begin{tabular}{rll}
...
3 & Range & \code{0-9}
\\
4 & Concaenation & \code{[0-9][ab]}, \code{ab}
\\
5 & Intersection & \code{[a-z\&\&[aeiou]]}
\\
5.5 & Negation & \code{[\^{}aeiou]}
\end{tabular}
\end{center}
%
