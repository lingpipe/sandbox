...
%
We have not shown the serial version ID definitions, but they are in
the file.  If the nested static class had been declared public, we
wouldn't have needed to define the public no-argument constructor.
