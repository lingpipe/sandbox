...
It is a very short step from these simple examples to building a web service
that aggregates news feeds from around the world and indexes them for keyword search.
In this book we aim to give you the information you need to do this by working
through the details of how character data is encoded/decoded into bytes and how
this data is sent and retrieved to and from the operating system.
