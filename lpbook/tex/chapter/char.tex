...
ID CD TYPE                     ID CD TYPE
 ...
 1 Lu UPPERCASE_LETTER         16 Cf FORMAT
 2 Ll LOWERCASE_LETTER         18 Co PRIVATE_USE
 3 Lt TITLECASE_LETTER         19 Cs SURROGATE
 4 Lm MODIFIER_LETTER
 5 Lo OTHER_LETTER             20 Pd DASH_PUNCTUATION
 6 Mn NON_SPACING_MARK         21 Ps START_PUNCTUATION
 7 Me ENCLOSING_MARK           22 Pe END_PUNCTUATION
 8 Mc COMBINING_SPACING_MARK   23 Pc CONNECTOR_PUNCTUATION
...
14 Zp PARAGRAPH_SEPARATOR      29 Pi INITIAL_QUOTE_PUNCTUATION
                               30 Pf FINAL_QUOTE_PUNCTUATION
\end{verbatim}
%
Note that the types are arranged alphabetically, with spaces between
the main types (and put into two columns for the book).  The initial
character of a type, which is capitalized, indicates the main
