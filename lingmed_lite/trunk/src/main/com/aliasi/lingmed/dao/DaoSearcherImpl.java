...
import com.aliasi.lingmed.medline.Fields;

import com.aliasi.lingpipe.util.Iterators;
...
public class DaoSearcherImpl<E> implements DaoSearcher<E> {
    ...
    public DaoSearcherImpl(Codec<E> codec,
        ...
        mCodec = codec;
        mQueryParser 
            = new QueryParser(Version.LUCENE_36,Fields.DEFAULT_FIELD,mQueryAnalyzer);
        mSearcher = searcher;
    }
