...
instance,
%
\commandlinefollow{ant -Dregex={\bk}A(xyz){\bk}z -Dtext=xyz regex-group}
\begin{verbatim}
...
consider
%
\commandlinefollow{ant -Dregex="(\d+).*({\bk}1)" -Dtext="12 over 12" regex-group}
\begin{verbatim}
...
%
\commandlinefollow{ant -Dregex=\d+ -Dreplacement=0 -Dtext="+1 (718) 290-9170" regex-replace}
\begin{verbatim}
