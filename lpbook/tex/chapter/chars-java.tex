...
\mbox{\code{0b100001111111111111111}}, which is 21 bits long.
...
method \code{codePointCount(char[],int,int)} returns the number of
...
The code may be run from the Ant target \code{validate-utf16}. 
%
