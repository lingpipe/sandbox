...
%
In general, you have to order the catches from more specific to mroe
...
\code{org.xml.sax}, provides an input abst\path{raction for XML documents}
...
by declaring it implements \code{Serializable}, then definining two
...
is the requisit public no-argument constructor, as well as a
...
\code{getClass()} on the varialbes of type \code{Object} read back in.
