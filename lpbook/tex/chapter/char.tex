...
JVM.%
%
\footnote{The JVM option \code{+XX:-XX:+UseCompressedOops} will reduce
...
which returns the character encoding with a specified name.  Once a
\code{Charset} is obtained, its methods \code{newEncoder()} and
\code{newDecoder()} may be used to get fresh encoders or decoders for
