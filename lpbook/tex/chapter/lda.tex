\chapter{Latent Dirichlet Allocation}\label{chap:lda}
...
\refsec{corpora-wormbase} for mroe information).  Similar data from a
...
based on LingPipe's \code{FileLineReader} utility (see the section on
...
extenalizable utility (see the section on \code{AbstractExternalizable}
