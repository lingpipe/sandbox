...
%
\footnote{In theory, UTF-8 has a larger range that UTF-16, but in practice,
the Unicode standard limits the maximum code point to 0x10FFFF, which
...
Java's primitive \code{char} data type 
is a single 16-bit Unicode character in the range
\unicode{0000} to \unicode{FFFF}.
...
sequence of two \code{char}s, (see \refsec{utf-16}).
