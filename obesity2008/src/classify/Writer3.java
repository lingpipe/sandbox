...
public class Writer3 {
    ...
    public Writer3(File file) throws IOException, SAXException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String modelDirName = "non-cvs/models/run3";
        String intuitiveOutputFileName = "submission/alias-i-intuitive-3.xml";
        String textualOutputFileName = "submission/alias-i-textual-3.xml";
