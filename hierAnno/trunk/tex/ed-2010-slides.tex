...
\\[4pt]
e.g. \ $\beta_i \sim \mathsf{Norm}(0,\Sigma)$, \ \ \ $\sigma^2 \sim \mathsf{Unif}(0,100)$
\item
...
\sld{Multimodal Priors and Annotator Random Effects}
...
\begin{itemize}
\footnotesize
\item E.g. annotator training, annotator native language, etc.
\end{itemize}
\end{itemize}
