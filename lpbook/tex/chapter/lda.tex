...
\code{GibbsSample}, which is a static class nested in
...
We define a class \code{ReporingLdaSampleHandler} which follows our
generic handler pattern.  The class declaration, member variables and
constructor are as follows.
%
\codeblock{ReporingLdaSampleHandler.1}
%
...
\code{ObjectHandler<GibbsSample>}.  Its single method is implemented
as
