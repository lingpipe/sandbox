...
\section{Array-Backed Input Streams}
...
\section{Array-Backed Output Streams}

The array-backed output streams and writers buffer the bytes or
characters written to them and provide access to them as an array
at any time.
