...
public class Writer2 {
    ...
    public Writer2(File file) throws IOException, SAXException {
    ...
    public static void main(String[] args) throws Exception {
        String inputFileName = "data/pre-processed/obesity_patient_records_test_preprocessed.xml";
        String modelDirName = "non-cvs/models/run2";
        String intuitiveOutputFileName = "submission/alias-i-intuitive-2.xml";
        String textualOutputFileName = "submission/alias-i-textual-2.xml";
