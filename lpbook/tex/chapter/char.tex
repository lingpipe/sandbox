...
useful open source tools for dealing with Unicode and
...
encodings.  Even when character encodings are specified, say for
an XML document, they can be wrong.  ICU does a good job at 
detecting the character encoding from a sequence of bytes.  Using
it is simple, 
