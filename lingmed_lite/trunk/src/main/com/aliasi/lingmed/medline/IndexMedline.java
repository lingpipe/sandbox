...
public class IndexMedline extends AbstractCommand {
    ...
    private IndexMedline(String[] args) throws Exception {
        ...
        mIndex = FileUtils.checkIndex(mIndexName);
	...
	System.out.println(codecClassName);
        ...
        System.out.println("Codec class=" + mCodec.getClass());
        ...
        try {
            ...
            if (files.length > 0) {
                ...
                IndexWriterConfig iwConf 
                    = new IndexWriterConfig(Version.LUCENE_36,mCodec.getAnalyzer());
	...
	System.out.println("Got index" + index);
        ...
        try {
            if (isNewDirectory(mIndex)) return LOW_SORT_STRING;
            Directory fsDir = FSDirectory.open(mIndex);
            ...
            SortField sortField
                = new SortField(Fields.MEDLINE_FILE_FIELD,SortField.STRING);
    ...
    static class MedlineIndexer implements MedlineHandler {
        ...
        public MedlineIndexer(IndexWriter indexWriter, MedlineCodec codec) 
            ...
            mMedlineCodec = codec;
            // recheck - Lucene 3.6 might not need this any more...
            if (sIsBaseline) {
                mReader = null;
                mSearcher = null;
            } else {
        ...
        public void handle(MedlineCitation citation) {
            ...
            try {
                if (sIsBaseline) {
                    System.out.println("add document: " + citation.pmid());
                    System.out.flush();
